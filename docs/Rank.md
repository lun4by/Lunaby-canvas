...
--- | --- | ---
options | [BuildOptions](https://github.com/squarfiuz/lunaby-canvas/tree/main/docs/typedef/BuildOptions.md) | Build options
...
PARAMETER | TYPE | DESCRIPTION
--- | --- | ---
options | [LevelColorOptions](https://github.com/squarfiuz/lunaby-canvas/tree/main/docs/typedef/LevelColorOptions.md) | The options for the level color
...
PARAMETER | TYPE | DESCRIPTION
--- | --- | ---
options | [RankColorOptions](https://github.com/squarfiuz/lunaby-canvas/tree/main/docs/typedef/RankColorOptions.md) | The options for the rank color
