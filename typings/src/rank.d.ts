 ...
 * @typedef {object} Rank
 * @see {Rank}
 * @example const rankCard = await new lunaby-canvas.Rank()
 * @type {Class}
 */
declare class Rank {
    data: Lunaby-canvasRankData;
...
declare namespace Rank { export { Lunaby-canvasRankData }; }

type Lunaby-canvasRankData = {
