 ...
 * @see {Tweet}
 * @example const TweetCard = await new lunaby-canvas.Tweet()
 * @type {Class}
 */
declare class Tweet {
    data: Lunaby-canvasTweetData;
   ...
   * @returns {Tweet}
   * @example setComment("This is a tweet card. You can customize it as you wish. Enjoy! #Lunaby-canvas")
   */
...
declare namespace Tweet { export { Lunaby-canvasTweetData }; }

type Lunaby-canvasTweetData = {
    avatar: "https://cdn.discordapp.com/avatars/928259219038302258/299ebac2bc13f5a8f44d2dd1f0c9f856.png?size=1024";
    comment: "This is a tweet card. You can customize it as you wish. Enjoy! #Lunaby-canvas";
    verified: false;
    client: null;
    theme: "light";
