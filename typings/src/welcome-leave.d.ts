 ...
 * @see {WelcomeLeave}
 * @example const welcomeLeaveCard = await new lunaby-canvas.WelcomeLeave()
 * @type {Class}
 */
declare class WelcomeLeave {
    data: Lunaby-canvasWelcomeLeaveData;
...
declare namespace WelcomeLeave { export { Lunaby-canvasWelcomeLeaveData }; }

type Lunaby-canvasWelcomeLeaveData = {
