 ...
 * @see {Security}
 * @example const SecurityCard = await new lunaby-canvas.Security()
 * @type {Class}
 */
declare class Security {
    data: Lunaby-canvasSecurityData;
...
declare namespace Security { export { Lunaby-canvasSecurityData }; }

type Lunaby-canvasSecurityData = {
