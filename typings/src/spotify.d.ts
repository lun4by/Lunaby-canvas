 ...
 * @see {Spotify}
 * @example const spotifyCard = await new lunaby-canvas.Spotify()
 * @type {Class}
 */
declare class Spotify {
    data: Lunaby-canvasSpotifyData;
...
declare namespace Spotify { export { Lunaby-canvasSpotifyData }; }

type Lunaby-canvasSpotifyData = {
  album : null;
  artist : null;
  border : null;
  _bar_width : 1400;
