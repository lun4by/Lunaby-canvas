 ...
 * @typedef {object} Ship
 * @see {Ship}
 * @example const shipCard = await new lunaby-canvas.Ship()
 * @type {Class}
 */
declare class Ship {
    data: Lunaby-canvasShipData;
...
declare namespace Ship { export { Lunaby-canvasShipData }; }

type Lunaby-canvasShipData = {
