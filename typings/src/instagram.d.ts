 ...
 * @see {Instagram}
 * @example const InstagramCard = await new lunaby-canvas.Instagram()
 * @type {Class}
 */
declare class Instagram {
    data: Lunaby-canvasInstagramData;
...
declare namespace Instagram { export { Lunaby-canvasInstagramData }; }

type Lunaby-canvasInstagramData = {
