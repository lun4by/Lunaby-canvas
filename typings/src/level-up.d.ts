 ...
 * @see {LevelUp}
 * @example const LevelUpCard = await new lunaby-canvas.LevelUp()
 * @type {Class}
 */
declare class LevelUp {
    data: Lunaby-canvasLevelUpData;
...
declare namespace LevelUp { export { Lunaby-canvasLevelUpData }; }

type Lunaby-canvasLevelUpData = {
