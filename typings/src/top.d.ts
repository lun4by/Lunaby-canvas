 ...
 * @typedef {object} Top
 * @see {Top}
 * @example const leaderBoardCard = await new lunaby-canvas.Top()
 * @type {Class}
 */
declare class Top {
    data: Lunaby-canvasTopData;
...
declare namespace Top { export { Lunaby-canvasTopData }; }

type Lunaby-canvasTopData = {
